...
const voiceurl = "https://"+window.location.host+"/voice"+window.location.pathname;

const tempuuid = window.location.pathname;
const uuid = tempuuid.substr(1);
window.websocket_open = false;
...
const interval = setInterval(function() {
    ...
    getJSON(voiceurl).then(data => {
    if (JSON.stringify(window.uuids)!=JSON.stringify(data)) {
        console.log(window.uuids);
        console.log(data);
        window.uuids = data;
